...
const enUS = {
  ...
  results: {
    ...
    insights: {
      ...
      avgLabel: 'Avg Price',
      detailButton: 'Detailed Stats',
      detailTitle: 'Market Detail Stats',
      trendSection: 'Price Trend',
      currentSection: 'Current Snapshot',
      historySection: 'Historical Snapshot',
    },
    chart: {
      avgPrice: 'Average',
      medianPrice: 'Median',
